define(['ytHelper', 'song_builder', 'recognitionImageBuilder', 'recognitionList', 'backend'], function(ytHelper, songBuilder, recognitionImageBuilder, recognitionList, backend){
    'use strict';
            ...
            $.each(urls, function(key, url) {
                ...
                if (videoId == null) {
                    ...
                    ytHelper.recognizeSpotify(videoId.id, function(json) {
                        ...
                        ytHelper.findVideo(song, function(song,json) {
